...
$subtitle   = $subtitle ?? 'Subtitle or phrase goes here';
$cards      = $cards ?? [];
        ...
        <div class="cards-wrapper">
            ...
            <div data-animate class="card slim">
                ...
                <div class="info">
                    ...
                    <p class="text-small secondary-font"><i class="fa-regular fa-clock"></i> <?= htmlspecialchars($time_available) ?></p>
                </div>
...
<!-- <section class="cards section">
    <div class="container">
        ...
        <div class="single">
            <h1 data-animate class="title-medium">WELKOM BIJ STUDIO MONACO</h1>
            <p data-animate class="text-big secondary-font max-width-600">
